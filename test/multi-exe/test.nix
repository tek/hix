{
  ...
  source = ''
    ...
    output_exact '[ "dev-pkg1" "dev-pkg2" "ghc910-pkg1" "ghc910-pkg2" "ghc910-pkg4" "ghc912-pkg1" "ghc912-pkg2" "ghc912-pkg4" "ghc98-pkg1" "ghc98-pkg2" "ghc98-pkg4" ]'
    ...
    output_exact '[ "__hix-internal__" "build" "bump" "cmd" "dev" "env" "ghc910" "ghc912" "ghc98" "hix-build-tools" "hls" "hpack" "hpack-quiet" "lower" "managed" "min" "overrides" "p2" "pkg1" "pkg2" "profiled" "project" ]'
