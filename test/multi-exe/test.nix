{...}:
{
  test = builtins.toFile "multi-exe-test" ''
    ...
    output_exact '[ "__hix-internal__" "build" "bump" "candidates" "cmd" "config" "dev" "docs" "env" "ghc" "ghc0" "ghc90" "ghc92" "ghc94" "ghc96" "hackage" "hpack" "hpack-quiet" "lower" "managed" "overrides" "p2" "pkg1" "pkg2" "pkgs" "release" "show-config" ]'
