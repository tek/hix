{
  ...
  source = ''
    ...
    output_exact '[ "__hix-internal__" "build" "bump" "cmd" "dev" "env" "ghc910" "ghc94" "ghc96" "ghc98" "hix-build-tools" "hls" "hpack" "hpack-quiet" "lower" "managed" "min" "overrides" "p2" "pkg1" "pkg2" "profiled" "project" ]'
