{...}: {
  test = builtins.toFile "lower-test" ''
    ...
    target_out_init='{"failed":[],"failedNames":null,"modified":[{"package":"aeson","range":">=2.0.2.0 && <2.3","version":"2.0.2.0"},{"package":"extra","range":">=1.7.7 && <1.8","version":"1.7.7"}],"modifiedNames":"aeson, extra","unmodified":[],"unmodifiedNames":null}'
