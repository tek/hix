{ obelisk }:
{ hackage, source, override, pkgs, jailbreak, ... }:
{
  # reflex
  ...
  universe-reverse-instances = jailbreak (hackage "1.1.1" "1nd12c7q656bwb51mwsdb58qs9gs25ap2vlblfp102bfbanjlwfn");
  universe-some = jailbreak (hackage "1.2.1" "1nibfdln36sdaldz035qflzpxm5jkiqphi8v2ypa4k2qazwwpb46");
