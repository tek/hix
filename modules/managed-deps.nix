...
with lib;
{
  options = with types; {
    managedDeps = {
      ...
      update = mkOption {
        description = mdDoc ''
        Whether to build the project with the new dependency versions and update [](#opt-managed-deps-managedDeps.file) on
        success.
        '';
        type = bool;
        default = true;
      ...
      generate = mkOption {
        description = mdDoc ''
        Whether to regenerate cabal files and override derivations after [updating](#opt-managed-deps-managedDeps.update) the
        project.
        '';
        type = bool;
        default = true;
